										...
										<div class="trend-top-cap">
											...
											<h2>
												<a href="latest_news.html" data-animation="fadeInUp"
													data-delay=".4s" data-duration="1000ms">Anna Lora Stuns
													In White At Her Australian Premiere</a>
											</h2>
											<p data-animation="fadeInUp" data-delay=".6s"
												data-duration="1000ms">by Alice cloe - Jun 19, 2020</p>
										</div>
									</div>
								</div>
							</div>
									...
									<nav>
										<div class="nav nav-tabs" id="nav-tab" role="tablist">
											...
											<a class="nav-item nav-link" id="nav-profile-tab"
												...
												aria-controls="nav-profile" aria-selected="false">Travel</a>
											...
											<a class="nav-item nav-link" id="nav-Sports"
												data-toggle="tab" href="#nav-nav-Sport" role="tab"
													...
													<div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
														<div class="whats-right-single mb-20">
															...
															<div class="whats-right-cap">
																...
																<h4>
																	<a href="latest_news.html">Portrait of group of
									...
									<div class="weekly2-news-active d-flex">
										...
										<div class="weekly2-single">
											...
											<div class="weekly2-caption">
												<h4>
													<a href="#">Scarlett’s disappointment at latest
														accolade</a>
												</h4>
												<p>Jhon | 2 hours ago</p>
											</div>
